## 線形グラデーションのマテリアル。
class_name LinearGradientPaintMaterial
...
## グラデーションの終点。
var end_point: Vector2 = Vector2(1, 0)
...
func _init() -> void:
	...
	start_point = quater_size
	end_point = quater_size * 3
...
func change_document_size(new_document_size: Vector2, anchor: PaintLayer.ScaleAnchor) -> void:
	...
	start_point += Vector2(delta_x, delta_y)
	end_point += Vector2(delta_x, delta_y)
